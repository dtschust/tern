...
(function(root, mod) {
  ...
  AVal.prototype = extend(ANull, {
    ...
    makeupType: function() {
      ...
      for (var i = this.forward.length - 1; i >= 0; --i) {
        ...
        if (hint && !hint.isEmpty()) {debugger; guessing = true; return hint;}
      }
      ...
      if (objs) {
        ...
        if (canon) {debugger; guessing = true; return canon;}
      }
    },
  ...
  var typeFinder = exports.typeFinder = {
    ...
    MemberExpression: function(node, scope) {
      if (node.object.object.name === 'TS') {
        debugger;
        var ret = findByPropertyName(propName(node));
        guessing = false;
        return ret;
      }
